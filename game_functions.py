...
def check_events(ai_settings,screen,stats,sb,play_button,ship,aliens,bullets):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings,screen,stats,sb,play_button,ship,aliens,bullets,mousex,mousey)
...
def update_bullets(aliens,bullets,ai_settings,stats,sb):
    '''update the bullets and get rid of the bullets'''
    bullets.update()
...
def get_number_rows(ai_settings,ship_height,alien_height):
    '''determines the number of rows of alien that can fit in the row'''
...
def check_aliens_bottom(ai_settings,stats,sb,screen,ship,aliens,bullets):
    ...
    #check alien bottom and increase difficulty
    for alien in aliens.sprites():
...
def update_aliens(ai_settings,stats,sb,screen,ship,aliens,bullets):
    '''updates the position of the all fleet of alien'''
...
def update_screen(ai_settings,screen,stats,sb,ship,alien,bullets,play_button):
    ...
    clock.tick(FPS)         #setting fps for game
    ...
    #alien.draw(screen) #draw is used in sprite according to rect attributes
